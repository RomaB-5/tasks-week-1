...
template <class T>
concept Fundamental = std::is_fundamental_v<T> && !std::is_same_v<T, void> && !std::is_same_v<T, std::nullptr_t>;
...
private:
    ...
    std::uint64_t m_type_id = TypeID<void>::id();
